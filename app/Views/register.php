    ...
    <form action="" method="POST">
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="firstname" name="firstname"
                   ...
                   title="<?=Util::html($studentValidator->getMessage('firstname'))?>" required
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="lastname" name="lastname"
                   ...
                   title="<?=Util::html($studentValidator->getMessage('lastname'))?>" required
        ...
        <div class="form-group">
            ...
            <div class="radio-inline">
                ...
                <input type="radio" id="male" name="gender" value="male" required
                       <?php if(isset($userData['gender']) && $userData['gender'] == 'male'): ?> checked
                       <?php endif; ?>
                >М
                </label>
            </div>
            <div class="radio-inline">
                ...
                <input type="radio" id="female" name="gender" value="female" required
                       <?php if(isset($userData['gender']) && $userData['gender'] == 'female'): ?> checked
                       <?php endif; ?>
                >Ж
                </label>
            </div>
        ...
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="year" name="year"
                   ...
                   title="<?=Util::html($studentValidator->getMessage('year'))?>" required
            ...
            <div class="radio-inline">
                <label for="resident">
                    <input type="radio" id="resident" name="residence" value="resident" required
                        <?php if(isset($userData['residence']) && $userData['residence'] == 'resident'): ?> checked
                        <?php endif; ?>
                    >Местный
                </label>
            </div>
            <div class="radio-inline">
                <label for="nonresident">
                    <input type="radio" id="nonresident" name="residence" value="nonresident" required
                        <?php if(isset($userData['residence']) && $userData['residence'] == 'nonresident'): ?> checked
                        <?php endif; ?>
                    >Иногородний
                </label>
            </div>
